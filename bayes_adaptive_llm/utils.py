...
def get_preference_pair(
    ...
    if single_action_pair:
        logging.info("Selected single-action preference pair for action %s", target_idx)
        return single_action_pair
    logging.info("No single-action pair found for action %s, trying cross-action.", target_idx)
