...
class TRIPPipelineForRecommendation(TRIPPipeline):
...
class TRIPPipelineForNegotiation(TRIPPipeline):
...
class TRIPPipelineForEmotionalSupport(TRIPPipeline):
...
class TRIPPipelineForPersuation(TRIPPipeline):
