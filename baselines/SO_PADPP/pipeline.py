...
class SOPADPPPipeline(Pipeline):
...
class SOPADPPPipelineForRecommendation(SOPADPPPipeline):
...
class SOPADPPPipelineForNegotiation(SOPADPPPipeline):
...
class SOPADPPPipelineForEmotionalSupport(SOPADPPPipeline):
...
class SOPADPPPipelineForPersuation(SOPADPPPipeline):
